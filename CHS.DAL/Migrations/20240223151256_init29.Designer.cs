...
namespace CHS.DAL.Migrations
{
    ...
    [Migration("20240223151256_init29")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CHS.DAL.Entites.Record", b =>
                {
                    ...
                    b.HasKey("InstructorId", "StudentId", "LectureId", "Week");
            ...
            modelBuilder.Entity("CHS.DAL.Entites.Teach", b =>
                {
                    ...
                    b.HasKey("InstructorId", "CourseGroupId");
            ...
            modelBuilder.Entity("CHS.DAL.Entites.Enroll", b =>
                {
                    b.HasOne("CHS.DAL.Entities.Course", null)
                        .WithMany("Enrolls")
                        .HasForeignKey("CourseCode");
            ...
            modelBuilder.Entity("CHS.DAL.Entites.Teach", b =>
                {
                    b.HasOne("CHS.DAL.Entites.CourseGroup", "CourseGroup")
                        .WithOne("Teach")
                        .HasForeignKey("CHS.DAL.Entites.Teach", "CourseGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
